...
import "../chunk-OOCQCOMX.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-5DNZZX4G.js";
import "../chunk-HJRG6PKL.js";
import {
...
import "../chunk-IYTXLNLE.js";
import "../chunk-RLZWDN5B.js";
import {
...
} from "../chunk-AZCEA4BW.js";
import {
  UniverSheetsConditionalFormattingPlugin
} from "../chunk-QFSZPGGK.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-BM6EVJNS.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-73ZZCVYS.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
