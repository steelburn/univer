...
var SheetNumfmtUIController = class extends Disposable {
  ...
  _forceUpdate(unitId) {
    var _a, _b;
    const resolvedUnitId = unitId != null ? unitId : (_a = this._univerInstanceService.getCurrentUnitOfType(2 /* UNIVER_SHEET */)) == null ? void 0 : _a.getUnitId();
    if (!resolvedUnitId) {
      return;
    }
    ...
    (_b = renderUnit == null ? void 0 : renderUnit.mainComponent) == null ? void 0 : _b.makeDirty();
  }
  _initCommands() {
    [
...
function Options() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "univer-grid univer-gap-1 univer-p-1.5", children: menuOptions.map((item, index) => {
    if (item === "|") {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "univer-mb-5 univer-mt-3.5 univer-flex univer-justify-end", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Button, { onClick: handleCancel, className: "univer-mr-3", children: localeService.t("sheets-numfmt-ui.cancel") }),
