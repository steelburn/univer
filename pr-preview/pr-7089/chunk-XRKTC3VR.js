...
function resolveFormulaSelectionDataStream(accssor, editor, editorId) {
  ...
  const documentModel = editorDocumentModel != null ? editorDocumentModel : univerInstanceService.getCurrentUniverDocInstance();
...
function useFormulaSelecting(opts) {
  ...
  const calculateSelectingType = useEvent(() => {
    ...
    const nodes = ((_d = lexerTreeBuilder.sequenceNodesBuilder(dataStream)) != null ? _d : []).map((node) => {
    ...
    if ((dataStream == null ? void 0 : dataStream.substring(0, 1)) === "=" && (adding || editing)) {
      if (editing) {
        ...
        const currentUnitId = (_e = resolveFormulaSelectionWorkbook(
          univerInstanceService.getCurrentUnitOfType(2 /* UNIVER_SHEET */),
          workbook
        )) == null ? void 0 : _e.getUnitId();
...
function useSheetHighlight(unitId, subUnitId) {
  ...
  const renderManagerService = useDependency(IRenderManagerService);
  const currentWorkbook = useObservable((0, import_react8.useMemo)(() => univerInstanceService.getCurrentTypeOfUnit$(2 /* UNIVER_SHEET */), [univerInstanceService]));
...
function createSelectionChangeHandler(opts) {
  ...
  return (selections, isEnd, options) => {
    if ((options == null ? void 0 : options.initial) && selections.length <= opts.initialSelectionsCount) {
      return;
    }
...
function getInitialFormulaReferenceSelectionCount(renderSelectionCount, formulaReferenceCount, selectingType) {
  if (selectingType === 1 /* NEED_ADD */ && formulaReferenceCount === 0) {
    return 0;
  }
...
function syncCounterpartFormulaEditorSelection(editorService, editorId, selections) {
  ...
  (_a = editorService.getEditor(syncEditorId)) == null ? void 0 : _a.setSelectionRanges(selections);
}
...
function RangeSelectorDialog(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    Dialog,
    {
      ...
      mask: false,
      maskClosable: false,
      footer: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("footer", { className: "univer-flex univer-gap-2", children: [
