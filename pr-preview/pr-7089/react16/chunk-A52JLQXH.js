...
var configSymbol = Symbol(SHEETS_DRAWING_UI_PLUGIN_CONFIG_KEY);
...
// ../packages/sheets-drawing-ui/src/services/drawing-context-menu.service.ts
var IDrawingContextMenuService = createIdentifier("sheets-drawing-ui.drawing-context-menu.service");
var DrawingContextMenuService = class extends Disposable {
  ...
  getContextMenuPosition(context) {
    var _a;
    return (_a = this._providers.get(context.drawingType)) == null ? void 0 : _a.getContextMenuPosition(context);
  }
};
...
var DrawingContextMenuController = class extends RxDisposable {
  constructor(_drawingManagerService, _contextMenuService, _renderManagerService, _univerInstanceService, _drawingContextMenuService) {
    ...
    __publicField(this, "_univerInstanceService", _univerInstanceService);
    __publicField(this, "_drawingContextMenuService", _drawingContextMenuService);
    this._init();
  }
  _init() {
  ...
  _getContextMenuPosition(drawings) {
    ...
    if (drawings.length !== 1) {
      return "contextMenu.drawing" /* DRAWING */;
    }
    const [drawing] = drawings;
    return (_a = this._drawingContextMenuService.getContextMenuPosition({
      unitId: drawing.unitId,
      subUnitId: drawing.subUnitId,
      drawingId: drawing.drawingId,
      drawingType: drawing.drawingType,
      drawing
    })) != null ? _a : "contextMenu.drawing" /* DRAWING */;
  }
};
...
var SHEET_EMBED_FLOAT_DOM_TRANSFORMER_CONFIG = {
  borderEnabled: true,
  borderStroke: "#4086f4",
  borderStrokeWidth: 1,
  borderSpacing: 2,
...
var FLOAT_DOM_RUNTIME_ACTIVATION_EVENT_PRIORITY = -100;
var FLOAT_DOM_STAGE2_CLICK_DISTANCE_THRESHOLD = 4;
var FLOAT_DOM_PREVIEW_OBJECT_SUFFIX = "__preview";
var EMBED_FLOAT_DRAG_HANDLE_POINTER_DOWN_EVENT = "univer:embed-float-drag-handle:pointerdown";
...
function createFloatDomMoveDragState(info, detail) {
  ...
  return {
    ...
    startLeft: Number((_a = info.rect.left) != null ? _a : 0),
    startTop: Number((_b = info.rect.top) != null ? _b : 0)
  };
}
...
function isStage2RuntimeEmbedFloatDom(floatDomParam) {
  ...
  return embedData.hostType === 2 /* UNIVER_SHEET */ && embedData.childType === 2 /* UNIVER_SHEET */ && embedData.runtimeMountMode === "stage2";
}
...
function isSheetHostedEmbedFloatDom(floatDomParam) {
  ...
  const embedData = floatDomParam.data;
  return embedData.hostType === 2 /* UNIVER_SHEET */ && embedData.childType != null;
}
...
function shouldForwardSheetHostedEmbedFloatDomEvent(floatDomParam, event) {
  ...
  const runtime = (_a = target == null ? void 0 : target.closest) == null ? void 0 : _a.call(target, '[data-embed-float-dom="true"]');
  return ((_b = runtime == null ? void 0 : runtime.dataset) == null ? void 0 : _b.embedFloatStage) !== "stage2";
}
...
function syncFloatDomHostSelectionOnStageEnter(stage, renderObject, rect) {
  ...
  if (stage === "stage1") {
    (_b = (_a = renderObject.scene).attachTransformerTo) == null ? void 0 : _b.call(_a, rect);
    return;
  }
  if (stage === "stage2" && rect.oKey) {
    renderObject.transformer.clearControlByIds([rect.oKey]);
    (_f = (_e = (_d = (_c = renderObject.scene).getTransformer) == null ? void 0 : _d.call(_c)) == null ? void 0 : _e.clearSelectedObjects) == null ? void 0 : _f.call(_e);
  }
}
...
function isCanvasFloatDomDrawingType(drawingType) {
  return drawingType === 8 /* DRAWING_DOM */ || drawingType === 9 /* DRAWING_BLOCK */ || drawingType === 2 /* DRAWING_CHART */;
}
function shouldActivateStage2FromHostPointer(info, event) {
  ...
  if (offsetX >= Math.min(position.startX, position.endX) && offsetX <= Math.max(position.startX, position.endX) && offsetY >= Math.min(position.startY, position.endY) && offsetY <= Math.max(position.startY, position.endY)) {
    return true;
  }
  const rect = info.rect;
  if (typeof rect.isHit === "function") {
    try {
      return rect.isHit({ x: offsetX, y: offsetY });
    } catch {
    }
  }
...
var SheetCanvasFloatDomManagerService = class extends Disposable {
  constructor(_renderManagerService, _univerInstanceService, _commandService, _drawingManagerService, _canvasFloatDomService, _sheetDrawingService, _lifecycleService, _canvasFloatDomPreviewService) {
    ...
    __publicField(this, "_canvasFloatDomPreviewService", _canvasFloatDomPreviewService);
    /**
  ...
  _handleEmbedFloatDragHandlePointerDown(event) {
    ...
    if (!(detail == null ? void 0 : detail.hostAnchorId)) {
      return;
    }
    ...
    const handlePointerUp = (pointerEvent) => {
      ...
      if (info.runtimeStage === "stage1") {
        (_a2 = scene.attachTransformerTo) == null ? void 0 : _a2.call(scene, info.rect);
      }
    };
  ...
  _commitFloatDomMove(info) {
    var _a;
    const skeletonParam = (_a = this._renderManagerService.getRenderById(info.unitId)) == null ? void 0 : _a.with(SheetSkeletonManagerService).getSkeletonParam(info.subUnitId);
    const drawing = this._sheetDrawingService.getDrawingByParam({
      unitId: info.unitId,
      subUnitId: info.subUnitId,
      drawingId: info.id
    });
    if (!skeletonParam || !(drawing == null ? void 0 : drawing.transform)) {
      return;
    }
    const transform = {
      ...drawing.transform,
  ...
  isFloatDomRuntimeMounted(id) {
    var _a;
    return ((_a = this._domLayerInfoMap.get(id)) == null ? void 0 : _a.runtimeMounted) === true;
  }
  ...
  _syncPreviewObjectTransform(previewObject, rect) {
    previewObject == null ? void 0 : previewObject.transformByState({
      left: rect.left,
      top: rect.top,
      width: rect.width,
      height: rect.height,
  ...
  _upsertFloatDomPreviewObject(scene, rect, rectShapeKey, drawingId, data) {
    var _a;
    const preview = (_a = this._canvasFloatDomPreviewService) == null ? void 0 : _a.getPreview(drawingId);
    if (!(preview == null ? void 0 : preview.image)) {
  ...
  mountFloatDomRuntime(id) {
    ...
    if (!(info == null ? void 0 : info.floatDomConfig)) {
      return false;
    }
  ...
  unmountFloatDomRuntime(id) {
    const info = this._domLayerInfoMap.get(id);
    if (!(info == null ? void 0 : info.runtimeMounted)) {
      return;
    }
    ...
    this.disposeWithMe(
      ...
      this._drawingManagerService.add$.subscribe((params) => {
        params.forEach((param) => {
          ...
          const rect = rectShape != null ? rectShape : this._createRenderObject({
            key: rectShapeKey,
            config: imageConfig,
            unitId,
            subUnitId,
          ...
          if (isChart) {
            rect.objectType = 6 /* CHART */;
          } else if (drawingType === 8 /* DRAWING_DOM */ || drawingType === 9 /* DRAWING_BLOCK */) {
            rect.objectType = 7 /* DRAWING_DOM */;
          }
          if (!rectShape) {
          ...
          if (shouldUsePreviewObject) {
            ...
            const previewSubscription = (_b = this._canvasFloatDomPreviewService) == null ? void 0 : _b.previewUpdated$.subscribe((preview) => {
          ...
          if (!shouldAutoMountRuntime) {
            ...
            const runtimeActivationListener = rect.onPointerDown$.subscribeEvent({
              ...
              next: ([evt, state]) => {
                if ((info == null ? void 0 : info.runtimeStage) === "stage1") {
...
// ../packages/sheets-drawing-ui/src/services/sheet-drawing-hit-test.service.ts
var SheetDrawingHitTestService = class extends Disposable {
  constructor(_drawingManagerService, _univerInstanceService, _renderManagerService) {
    super();
    __publicField(this, "_drawingManagerService", _drawingManagerService);
    __publicField(this, "_univerInstanceService", _univerInstanceService);
    __publicField(this, "_renderManagerService", _renderManagerService);
    __publicField(this, "_onDoubleClick$", new Subject());
    __publicField(this, "onDoubleClick$", this._onDoubleClick$.asObservable());
    __publicField(this, "_doubleClickDisposable", null);
    __publicField(this, "_boundRender", null);
    __publicField(this, "_boundScene", null);
    this._init();
  }
  dispose() {
  ...
  _init() {
    this.disposeWithMe(toDisposable(
      this._univerInstanceService.getCurrentTypeOfUnit$(2 /* UNIVER_SHEET */).subscribe(() => {
    ...
    this.disposeWithMe(toDisposable(
      this._renderManagerService.created$.subscribe((render2) => {
        const context = this._getActiveSheetContext();
        if (render2.unitId === (context == null ? void 0 : context.unitId)) {
          this._bindDoubleClickListener();
        }
      })
    ));
    this.disposeWithMe(toDisposable(
      this._renderManagerService.disposed$.subscribe((unitId) => {
        var _a;
        if (unitId === ((_a = this._boundRender) == null ? void 0 : _a.unitId)) {
          this._disposeDoubleClickListener();
        }
      })
    ));
  ...
  _bindDoubleClickListener() {
    ...
    const render2 = this._renderManagerService.getRenderById(context.unitId);
    const scene = render2 == null ? void 0 : render2.scene;
    if (!render2 || !scene) {
      this._disposeDoubleClickListener();
      return;
    }
    if (this._boundRender === render2 && this._boundScene === scene && this._doubleClickDisposable) {
      return;
    }
    this._disposeDoubleClickListener();
    ...
    this._boundRender = render2;
    this._boundScene = scene;
  }
  _disposeDoubleClickListener() {
    var _a;
    (_a = this._doubleClickDisposable) == null ? void 0 : _a.dispose();
  ...
  _hitTestScene(scene, unitId, subUnitId, offsetX, offsetY) {
    ...
    const oKey = typeof (pickedObject == null ? void 0 : pickedObject.oKey) === "string" ? pickedObject.oKey : null;
    if (!oKey) {
      return null;
    }
  ...
  _getActiveSheetContext() {
    ...
    const workbook = this._univerInstanceService.getCurrentUnitOfType(2 /* UNIVER_SHEET */);
    const unitId = workbook == null ? void 0 : workbook.getUnitId();
    const subUnitId = (_a = workbook == null ? void 0 : workbook.getActiveSheet()) == null ? void 0 : _a.getSheetId();
    if (!unitId || !subUnitId) {
      return null;
    }
    return { unitId, subUnitId };
...
SheetDrawingHitTestService = __decorateClass([
  __decorateParam(0, IDrawingManagerService),
  __decorateParam(1, IUniverInstanceService),
  __decorateParam(2, IRenderManagerService)
...
__publicField(UniverSheetsDrawingUIPlugin, "packageName", package_default.name);
__publicField(UniverSheetsDrawingUIPlugin, "version", package_default.version);
