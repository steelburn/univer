...
function getDeleteAndInsertCustomBlockActions(segmentId, oldSegmentId, segmentPage, offset, drawingId, documentDataModel, docSelectionRenderManager) {
  ...
  const rawActions = [];
  const oldBody = (_a = documentDataModel.getSelfOrHeaderFooterModel(oldSegmentId)) == null ? void 0 : _a.getBody();
  const body = (_b = documentDataModel.getSelfOrHeaderFooterModel(segmentId)) == null ? void 0 : _b.getBody();
  if (oldBody == null || body == null) {
    return;
  }
  const oldOffset = (_d = (_c = oldBody.customBlocks) == null ? void 0 : _c.find((block) => block.blockId === drawingId)) == null ? void 0 : _d.startIndex;
  if (oldOffset == null) {
    return;
  }
...
var UpdateDocDrawingWrappingStyleCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const documentDataModel = univerInstanceService.getCurrentUnitOfType(1 /* UNIVER_DOC */);
...
var IMoveInlineDrawingCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const renderManagerService = accessor.get(IRenderManagerService);
    const docSelectionRenderService = (_a = renderManagerService.getRenderUnitById(unitId)) == null ? void 0 : _a.with(DocSelectionRenderService);
...
var DocDrawingPosition = (props) => {
  ...
  function handleVerticalRelativeFromChange(value) {
    ...
    const documentDataModel2 = univerInstanceService.getUnit(unitId2, 1 /* UNIVER_DOC */);
    const skeleton = (_a = renderManagerService.getRenderUnitById(unitId2)) == null ? void 0 : _a.with(DocSkeletonManagerService).getSkeleton();
    const docSelectionRenderService = (_b = renderManagerService.getRenderUnitById(unitId2)) == null ? void 0 : _b.with(DocSelectionRenderService);
    ...
    const drawing = (_e = (_d = (_c = documentDataModel2 == null ? void 0 : documentDataModel2.getSelfOrHeaderFooterModel(segmentId)) == null ? void 0 : _c.getBody()) == null ? void 0 : _d.customBlocks) == null ? void 0 : _e.find((c) => c.blockId === drawingId);
    ...
    const line = (_f = glyph == null ? void 0 : glyph.parent) == null ? void 0 : _f.parent;
    ...
    const page = (_g = column == null ? void 0 : column.parent) == null ? void 0 : _g.parent;
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "header",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: localeService.t("docs-drawing-ui.image-position.title") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: localeService.t("docs-drawing-ui.image-position.horizontal") })
          }
        ),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: localeService.t("docs-drawing-ui.image-position.absolutePosition") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  InputNumber,
                  {
                    min: MIN_OFFSET,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: localeService.t("docs-drawing-ui.image-position.toTheRightOf") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  Select,
                  {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: localeService.t("docs-drawing-ui.image-position.vertical") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: localeService.t("docs-drawing-ui.image-position.bellow") }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  Select,
                  {
                    disabled,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: localeService.t("docs-drawing-ui.image-position.options") })
          }
        ),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ...
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: localeService.t("docs-drawing-ui.image-text-wrap.title") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: localeService.t("docs-drawing-ui.image-text-wrap.wrappingStyle") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(RadioGroup, { value: wrappingStyle, onChange: handleWrappingStyleChange, direction: "vertical", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: "inline" /* INLINE */, children: localeService.t("docs-drawing-ui.image-text-wrap.inline") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: "wrapSquare" /* WRAP_SQUARE */, children: localeService.t("docs-drawing-ui.image-text-wrap.square") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: "wrapTopAndBottom" /* WRAP_TOP_AND_BOTTOM */, children: localeService.t("docs-drawing-ui.image-text-wrap.topAndBottom") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: "behindText" /* BEHIND_TEXT */, children: localeService.t("docs-drawing-ui.image-text-wrap.behindText") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: "inFrontOfText" /* IN_FRONT_OF_TEXT */, children: localeService.t("docs-drawing-ui.image-text-wrap.inFrontText") })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: localeService.t("docs-drawing-ui.image-text-wrap.wrapText") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(RadioGroup, { disabled: disableWrapText, value: wrapText, onChange: handleWrapTextChange, direction: "horizontal", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: 0 /* BOTH_SIDES */, children: localeService.t("docs-drawing-ui.image-text-wrap.bothSide") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: 1 /* LEFT */, children: localeService.t("docs-drawing-ui.image-text-wrap.leftOnly") }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Radio, { value: 2 /* RIGHT */, children: localeService.t("docs-drawing-ui.image-text-wrap.rightOnly") })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: localeService.t("docs-drawing-ui.image-text-wrap.distanceFromText") })
          }
        ),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: localeService.t("docs-drawing-ui.image-text-wrap.top") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  InputNumber,
                  {
                    min: MIN_MARGIN,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: localeService.t("docs-drawing-ui.image-text-wrap.left") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  InputNumber,
                  {
                    min: MIN_MARGIN,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: localeService.t("docs-drawing-ui.image-text-wrap.bottom") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  InputNumber,
                  {
                    min: MIN_MARGIN,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: localeService.t("docs-drawing-ui.image-text-wrap.right") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  InputNumber,
                  {
                    min: MIN_MARGIN,
...
var DocDrawingPanel = () => {
  ...
  return !!(drawings == null ? void 0 : drawings.length) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DrawingCommonPanel, { drawings, hasAlign: false, hasCropper: true, hasGroup: false, hasTransform: false }),
...
// ../packages/docs-drawing-ui/src/controllers/components.controller.ts
...
function collectUpdatedDrawingIds(actions, drawingIds = /* @__PURE__ */ new Set()) {
  ...
  actions.forEach((action) => {
    if (Array.isArray(action)) {
      collectUpdatedDrawingIds(action, drawingIds);
    }
  });
  return drawingIds;
}
var DocDrawingAddRemoveController = class extends Disposable {
  ...
  _syncDrawingDataFromSnapshot(unitId, drawingIds) {
    ...
    const objects = drawingIds.filter((drawingId) => drawingData[drawingId] != null).map((drawingId) => ({ unitId, subUnitId: unitId, drawingId }));
    if (objects.length === 0) {
      return;
    }
...
// ../packages/docs-drawing-ui/src/views/DocPrintingFloatDom.tsx
...
var InsertDocDrawingCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const body = (_c = documentDataModel.getSelfOrHeaderFooterModel(segmentId)) == null ? void 0 : _c.getBody();
    if (body == null) {
      return false;
    }
    const textX = new TextX();
    const jsonX = JSONX.getInstance();
    const rawActions = [];
    const drawingOrderLength = (_e = (_d = documentDataModel.getSnapshot().drawingsOrder) == null ? void 0 : _d.length) != null ? _e : 0;
    ...
    if (collapsed) {
      ...
      const drawings2 = (_f = documentDataModel.getDrawings()) != null ? _f : {};
      const drawingOrder = (_g = documentDataModel.getDrawingsOrder()) != null ? _g : [];
...
function pickValidCustomBlockRenderViewport(viewport) {
  const result = {};
  if (isNonNegativeNumber(viewport == null ? void 0 : viewport.bleedLeft)) {
    result.bleedLeft = viewport.bleedLeft;
  }
  if (isPositiveNumber(viewport == null ? void 0 : viewport.bleedWidth)) {
    result.bleedWidth = viewport.bleedWidth;
  }
  if (isPositiveNumber(viewport == null ? void 0 : viewport.contentHeight)) {
    result.contentHeight = viewport.contentHeight;
  }
  if (isPositiveNumber(viewport == null ? void 0 : viewport.contentWidth)) {
    result.contentWidth = viewport.contentWidth;
  }
  if (isPositiveNumber(viewport == null ? void 0 : viewport.height)) {
    result.height = viewport.height;
  }
  if (isPositiveNumber(viewport == null ? void 0 : viewport.viewportHeight)) {
    ...
    params.forEach(async (param) => {
      ...
      for (const rect of rects) {
        ...
        const scrollListener = subscribeViewportScrollAfter(
          (_a = renderObject.scene.getViewport("viewMain" /* VIEW_MAIN */)) == null ? void 0 : _a.onScrollAfter$,
    ...
    this.disposeWithMe(
      this._drawingManagerService.refreshTransform$.subscribe((params) => {
        params.forEach((param) => {
          ...
          const currentProps = (_a = this._canvasFloatDomService.domLayers.find(([id]) => id === param.drawingId)) == null ? void 0 : _a[1].props;
...
function getRuntimeTransform(param, rect, fallbackViewport, fallbackTransform, preserveRuntimeGeometry) {
  var _a, _b, _c, _d, _e, _f, _g;
  const transform = (_b = param.transform) != null ? _b : (_a = param.transforms) == null ? void 0 : _a[0];
  const runtimeViewport = (_c = param.customBlockRenderViewport) != null ? _c : fallbackViewport;
  if (!param.customBlockRenderViewport && preserveRuntimeGeometry && fallbackTransform && transform) {
    return {
      ...transform,
      width: (_d = fallbackTransform.width) != null ? _d : transform.width,
      height: (_e = fallbackTransform.height) != null ? _e : transform.height
    };
  }
  if (!transform) {
    const height2 = (_f = runtimeViewport == null ? void 0 : runtimeViewport.height) != null ? _f : runtimeViewport == null ? void 0 : runtimeViewport.contentHeight;
    if (!isPositiveNumber(height2)) {
      return void 0;
    }
    return {
      left: rect.left,
  ...
  const height = (_g = runtimeViewport == null ? void 0 : runtimeViewport.height) != null ? _g : runtimeViewport == null ? void 0 : runtimeViewport.contentHeight;
...
function subscribeViewportScrollAfter(scrollEvent, callback) {
  ...
  if (typeof observable.subscribe === "function") {
    ...
    return toDisposable(() => {
      var _a;
      return (_a = subscription.unsubscribe) == null ? void 0 : _a.call(subscription);
    });
  }
  return void 0;
}
...
function mountDocPrintingFloatDom(props, root, injector) {
  const PrintingFloatDomInjector = connectInjector(DocPrintingFloatDom, injector);
  render(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PrintingFloatDomInjector, { ...props }), root);
  return () => unmount(root);
}

// ../packages/docs-drawing-ui/src/controllers/doc-drawing-printing.controller.ts
...
function getDocsPageRelativeDrawingLeft(config) {
  ...
  if (positionH.relativeFrom !== 0 /* PAGE */) {
    return;
  }
  if (positionH.align === 4 /* RIGHT */) {
    return hostPage.pageWidth - width;
  }
  if (positionH.align === 0 /* CENTER */) {
...
function getDocsPageRelativeDrawingTop(config) {
  ...
  if (positionV.relativeFrom !== 0 /* PAGE */) {
    return;
  }
  if (positionV.align === 0 /* BOTTOM */) {
    return hostPage.pageHeight - height;
  }
  if (positionV.align === 1 /* CENTER */) {
...
function getDocsDrawingBehindText(config) {
  ...
  return drawingOrigin.layoutType === 1 /* WRAP_NONE */ && drawingOrigin.behindDoc === 1 /* TRUE */;
}
...
function hasHorizontalTableViewport(viewport) {
  var _a, _b;
  return viewport != null && ((_a = viewport.leadingInsetLeft) != null ? _a : 0) + viewport.contentWidth + ((_b = viewport.trailingInsetRight) != null ? _b : 0) > viewport.viewportWidth;
}
var DocDrawingTransformUpdateController = class extends Disposable {
  ...
  _getStaleNonMultiDrawings(unitId, updateDrawingMap) {
    var _a;
    const drawingData = (_a = this._drawingManagerService.getDrawingData(unitId, unitId)) != null ? _a : {};
    return Object.values(drawingData).filter((drawing) => drawing.isMultiTransform !== 1 /* TRUE */).filter((drawing) => updateDrawingMap[drawing.drawingId] == null).map((drawing) => {
      var _a2, _b;
      return {
        unitId,
        subUnitId: unitId,
        ...
        transforms: (_a2 = drawing.transforms) != null ? _a2 : [],
        isMultiTransform: (_b = drawing.isMultiTransform) != null ? _b : 0 /* FALSE */
      };
    });
  }
  ...
  _calculateDrawingPosition(unitId, page, docsLeft, docsTop, updateDrawingMap, marginTop, marginLeft, hostPage, clipOffset) {
    ...
    skeDrawings.forEach((drawing) => {
      ...
      const pageClipBounds = getDocsDrawingPageClipBounds({
        ...
        pageOffsetLeft,
        pageOffsetTop,
        clipOffsetLeft: clipOffset == null ? void 0 : clipOffset.left,
      ...
      const transform = {
        left: (pageRelativeLeft != null ? pageRelativeLeft : aLeft) + docsLeft + (pageRelativeLeft == null ? this._liquid.x : pageOffsetLeft),
        top: (pageRelativeTop != null ? pageRelativeTop : aTop) + docsTop + (pageRelativeTop == null ? this._liquid.y : pageOffsetTop),
        width,
        height,
        angle,
      ...
      toDisposable(
        transformer.changeStart$.subscribe((state) => {
          ...
          for (const object of objects.values()) {
            ...
            const documentDataModel = this._univerInstanceService.getUnit(drawing.unitId, 1 /* UNIVER_DOC */);
    ...
    for (const key of Object.keys(drawings)) {
      ...
      if (drawingShapes.length) {
        for (const shape of drawingShapes) {
          ...
          try {
            shape.setOpacity(isDocInputFocusing ? 0.5 : 1);
          } catch (e) {
          }
  ...
  _editAreaChangeListener() {
    ...
    this.disposeWithMe(
      this._commandService.onCommandExecuted(async (command) => {
        ...
        const params = command.params;
        if ((params == null ? void 0 : params.unitId) && params.unitId !== this._context.unitId) {
          return;
        }
        queueMicrotask(() => {
          this._updateDrawingsEditStatus();
...
var RemoveDocDrawingCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const textX = new TextX();
    const jsonX = JSONX.getInstance();
    const customBlocks = (_d = (_c = (_b = documentDataModel.getSelfOrHeaderFooterModel(segmentId)) == null ? void 0 : _b.getBody()) == null ? void 0 : _c.customBlocks) != null ? _d : [];
    ...
    for (const block of removeCustomBlocks) {
      const { blockId } = block;
      const drawing = ((_e = documentDataModel.getDrawings()) != null ? _e : {})[blockId];
...
// ../packages/docs-drawing-ui/src/commands/commands/insert-shape.command.ts
var DOC_SHAPE_FILL = "#3A60F7";
var DOC_SHAPE_STROKE = "#1D3EA6";
function createShapeSvgSource(shape, width, height) {
  const content = shape === "ellipse" ? `<ellipse cx="${width / 2}" cy="${height / 2}" rx="${(width - 8) / 2}" ry="${(height - 8) / 2}" fill="${DOC_SHAPE_FILL}" stroke="${DOC_SHAPE_STROKE}" stroke-width="4" />` : `<rect x="4" y="4" width="${width - 8}" height="${height - 8}" rx="14" fill="${DOC_SHAPE_FILL}" stroke="${DOC_SHAPE_STROKE}" stroke-width="4" />`;
...
function createShapeInsertCommand(shape, width, height, id) {
  return {
    ...
    handler: async (accessor) => {
      ...
      const commandService = accessor.get(ICommandService);
      const univerInstanceService = accessor.get(IUniverInstanceService);
      const unitId = (_a = univerInstanceService.getCurrentUnitOfType(1 /* UNIVER_DOC */)) == null ? void 0 : _a.getUnitId();
      if (!unitId) {
        return false;
      }
...
var InsertDocRectangleShapeCommand = createShapeInsertCommand(
  "rectangle",
  144,
  96,
  "doc.command.insert-float-shape.rectangle"
);
var InsertDocEllipseShapeCommand = createShapeInsertCommand(
  "ellipse",
  112,
  112,
  ...
  return new Observable((subscriber) => {
    const observable = docSelectionManagerService.textSelection$.subscribe(() => {
      ...
      if (activeRange) {
        ...
        const tables = (_b = (_a = docDataModel == null ? void 0 : docDataModel.getSelfOrHeaderFooterModel(segmentId)) == null ? void 0 : _a.getBody()) == null ? void 0 : _b.tables;
...
// ../packages/docs-drawing-ui/src/menu/shape.menu.ts
var DOCS_SHAPE_MENU_ID = "doc.command.menu-insert-shape";
var DOCS_SHAPE_BELOW_MENU_ID = "doc.command.menu-insert-shape.below";
...
// ../packages/docs-drawing-ui/src/controllers/ui.controller.ts
