...
ComponentsController2 = __decorateClass([
  __decorateParam(0, Inject(IconManager))
...
var DropdownWidget = class {
  constructor(_univerInstanceService, _commandService, _renderManagerService, _dataValidationModel) {
    __publicField(this, "_univerInstanceService", _univerInstanceService);
    __publicField(this, "_commandService", _commandService);
    __publicField(this, "_renderManagerService", _renderManagerService);
    __publicField(this, "_dataValidationModel", _dataValidationModel);
...
function useSecondaryOptions(localeService) {
  const locale = localeService.getCurrentLocale();
  return (0, import_react22.useMemo)(() => FilterConditionItems.ALL_CONDITIONS.filter((c) => c.numOfParameters !== 2).map((c) => ({
...
var SheetsFilterRenderController = class extends RxDisposable {
  constructor(_context, _injector, _sheetSkeletonManagerService, _sheetsFilterService, _themeService, _sheetInterceptorService, _commandService) {
    super();
    __publicField(this, "_context", _context);
    __publicField(this, "_injector", _injector);
    __publicField(this, "_sheetSkeletonManagerService", _sheetSkeletonManagerService);
...
var SheetsFilterUIDesktopController = class extends SheetsFilterUIMobileController {
  constructor(_sheetsFilterPanelService, _sheetCanvasPopupService, _sheetsFilterService, _localeService, _shortcutService, _commandService, _menuManagerService, _contextService, _messageService, sheetsRenderService, renderManagerService) {
...
SheetsFilterUIDesktopController = __decorateClass([
  __decorateParam(0, Inject(SheetsFilterPanelService)),
  ...
  __decorateParam(9, Inject(SheetsRenderService)),
  __decorateParam(10, IRenderManagerService)
