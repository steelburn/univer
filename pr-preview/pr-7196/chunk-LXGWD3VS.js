...
var localeLabels = {
  ["arSA" /* AR_SA */]: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629",
  ["caES" /* CA_ES */]: "Catal\xE0",
  ["deDE" /* DE_DE */]: "Deutsch",
  ["enUS" /* EN_US */]: "English",
  ["esES" /* ES_ES */]: "Espa\xF1ol",
  ["faIR" /* FA_IR */]: "\u0641\u0627\u0631\u0633\u06CC",
  ["frFR" /* FR_FR */]: "Fran\xE7ais",
  ["idID" /* ID_ID */]: "Bahasa Indonesia",
  ["itIT" /* IT_IT */]: "Italiano",
  ["jaJP" /* JA_JP */]: "\u65E5\u672C\u8A9E",
  ["koKR" /* KO_KR */]: "\uD55C\uAD6D\uC5B4",
  ["plPL" /* PL_PL */]: "Polski",
  ["ptBR" /* PT_BR */]: "Portugu\xEAs (Brasil)",
  ["ruRU" /* RU_RU */]: "\u0420\u0443\u0441\u0441\u043A\u0438\u0439",
  ["skSK" /* SK_SK */]: "Sloven\u010Dina",
  ["viVN" /* VI_VN */]: "Ti\u1EBFng Vi\u1EC7t",
  ["zhCN" /* ZH_CN */]: "\u7B80\u4F53\u4E2D\u6587",
  ["zhHK" /* ZH_HK */]: "\u7E41\u9AD4\u4E2D\u6587\uFF08\u9999\u6E2F\uFF09",
  ["zhTW" /* ZH_TW */]: "\u7E41\u9AD4\u4E2D\u6587\uFF08\u53F0\u7063\uFF09"
};
function useLocale() {
  ...
  const localeLoader = configs == null ? void 0 : configs.localeLoader;
  const loadLocales = (0, import_react2.useCallback)(async (value) => {
    const locale = value;
    if (!localeLoader) {
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "e9615e2";
        const gitBranch = "dependabot/npm_and_yarn/tailwind-merge-3.6.0";
        const buildTime = "2026-07-06T06:56:39.205Z";
...
function Fab() {
  ...
  const items = fabEntryUnitType === 5 /* UNIVER_BASE */ || fabEntryUnitType === 3 /* UNIVER_SLIDE */ ? lightweightItems : fabEntryUnitType === 1 /* UNIVER_DOC */ ? [...globalItems, ...commonDebugItems, floatingDom].filter(Boolean) : sheetItems.filter(Boolean);
