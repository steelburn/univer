...
import "../chunk-A5HZSO5S.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-R3KTJ355.js";
import "../chunk-KL3CVMZM.js";
import {
  UniverDebuggerPlugin
} from "../chunk-TLO6JXAN.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-VN52YW3Z.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-RL6XQCHW.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
